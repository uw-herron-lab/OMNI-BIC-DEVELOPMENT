...
:: =============================================================
set "APP_EXE=C:\gitbuilds\OMNI-BIC-DEVELOPMENT\gRPC\Client Examples\ImpedanceCheckApp\bin\Release\ImpedanceCheckApp.exe"
:: =============================================================
set "LOG_DIRECTORY=C:\BICData\BIC_01_00\%TODAY%\impedances"
:: =============================================================
