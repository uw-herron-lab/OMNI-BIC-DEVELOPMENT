...
:: =============================================================
set "APP_EXE=C:\gitbuilds\OMNI-BIC-DEVELOPMENT\gRPC\Client Examples\EvokedPotentialsApp\bin\Release\EvokedPotentialsApp.exe"
:: =============================================================
set "CONFIG_FILE=C:\gitbuilds\OMNI-BIC-DEVELOPMENT\gRPC\config\BIC_01_00_config_template.json"
:: =============================================================
set "LOG_DIRECTORY=C:\BICData\BIC_01_00\%TODAY%\ccep"
:: =============================================================
