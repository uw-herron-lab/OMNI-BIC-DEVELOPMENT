...
#endif
    /**
    * Creates an instance of IImplantFactory.
    *
    * @param[in] enableLogging boolean for enable/disable logging
    * @param[in] file path to log file
    *
    * @return a factory for creation of IImplant instances. Caller takes ownership of the created pointer.
    */
    BIC_API cortec::implantapi::IImplantFactory* APIENTRY createImplantFactory(const bool enableLogging, const std::string& file);
